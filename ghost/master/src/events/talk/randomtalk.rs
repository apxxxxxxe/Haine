  ...
  let strings: Vec<RandomTalk> = match talk_type {
      TalkType::SelfIntroduce => vec![
        ...
        RandomTalk {
          id: "読書様式",
          text: "\
          h1113310無作為な乱読と目的意識下の通読。\\n\
          広い知識と深い知識、どちらも欠かせないものね。\\n\
          h1113306とはいえ、好みは分かれるもの。\\n\
          h1113204\\_a[ReadingType,ハイネは？]あなたはどちらが好き？\\_a\
          ".to_string(),
          required_condition: None,
          callback: None,
        },
      ...
      TalkType::WithYou => vec![
        ...
        RandomTalk {
          ...
          text: "\
            ...
            h1111210私の姿を見たければ、直接会いにきてちょうだい。逃げないから。\
            ".to_string(),
          required_condition: None,
          callback: None,
        },
