      ...
      TalkType::SelfIntroduce => vec![
        ...
        RandomTalk {
          ...
          text: "\
            ...
            h1111210今思えば、それが私らしい過ごし方だったのでしょうね。\\n\
            h1111204死後も、その性質は変わらないようだし。\
            ".to_string(),
          required_condition: None,
          callback: None,
        },
      ...
      TalkType::WithYou => vec![
        ...
        RandomTalk{
          ...
          text: "\
              ...
              私にも遠慮なく聞いてちょうだい。\\n\\n[half]\
              h1111206この館には、\\_a[AnchorTalk,ManorKnowledge,どんな本があるの？]長い年月をかけて集めた知識\\_aが眠っているの。\\n\
        ...
        RandomTalk {
          ...
          text: "\
            ...
            私にとってはとても落ち着く環境なのだけれど、\\n\
            h1111204あなたとってはどう？\\n\
            h1111210この静けさが重荷になるなんてこともあるのかしら。\\n\
            h1111204何か音楽でも聞きたくなったら、遠慮なく言ってちょうだい。\\n\
            h1111211あなたにとって心地よい環境を作りたいの。\
            ".to_string(),
          required_condition: None,
          callback: None,
        },
        ...
        RandomTalk {
          ...
          text: "\
            ...
            私には時間の感覚が曖昧になってしまったけれど、\\n\
            あなたには有意義に過ごしてもらいたいと思っているわ。\\n\
            h1111210何か興味を持てることがないか、一緒に探してみる？\
            ".to_string(),
          required_condition: None,
          callback: None,
        },
        ...
        // 現代的話題からの導入
        RandomTalk {
          id: "情報過多の時代".to_string(),
          text: "\
            h1111210今の時代、外は情報が溢れているのでしょうね。\\n\
            h1111306一瞬で世界中の出来事が分かってしまうなんて、\\n\
            便利でしょうけれど、疲れることもあるのではないかしら？\\n\\n[half]\
            h1111204私は意図的にそうした情報から距離を置いているけれど、\\n\
            あなたにとってはどう？\\n\
            h1111210そういった喧騒から離れたいとき、\\n\
            この館がその場所になっていれば良いのだけれど。\
            ".to_string(),
          required_condition: None,
          callback: None,
        },
      ...
      TalkType::Servant => vec![
        ...
        RandomTalk {
          ...
          text: "\
            ...
            詳細な技術資料まで様々よ。\\n\\n[half]\
            h1111304中には、生きていた時代の風俗や\\n\
            失われた技術についての貴重な証言もあるわ。\\n\
            h1111210私一人では到底知り得ない知識の宝庫。\\n\
            h1111206……まあ、彼らにとっても\\n\
