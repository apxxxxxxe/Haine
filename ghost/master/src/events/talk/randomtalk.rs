  ...
  let strings: Vec<RandomTalk> = match talk_type {
      ...
      TalkType::WithYou => vec![
        ...
        RandomTalk {
          id: "早口".to_string(),
          text: "\
            h1113205……\\![set,balloonwait,0.7]それでねφ、\\_w[500]\\n\
            だからこそこの仕組みが成り立つのφ。\\_w[700]\\n\
            h1113204ここまでは良いかしらφ？\\_w[700]\\n\
            h1113206そして、次に重要なのが……\\![set,balloonwait,1]\\n\\n[half]\
        ...
        RandomTalk {
          ...
          text: "\
            ...
            湯気が立っていることに気づいていない様子で、\\n\
            そのまま……\
            h1000000っ……。\\n\
            h1122205……熱かったわ。\\n\\n[half]\
            h1121205ぼんやりしているとよくやるの。\\n\
            h1121310何度も繰り返しているのだから、\\n\
            学べばいいのにね。\
          ".to_string(),
          required_condition: None,
          callback: None,
        ...
        RandomTalk {
          ...
          text: "\
            ...
            退屈であれば長く感じる。\\n\\n[half]\
            h1111204この館での時間は、\\n\
            あなたにとってどのように流れているのかしら？\\n\\n[half]\
            h1111206私は時間の感覚が曖昧になって久しいけれど、\\n\
