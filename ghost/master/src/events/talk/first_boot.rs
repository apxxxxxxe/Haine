...
pub(crate) static FIRST_BOOT_TALK: LazyLock<String> = LazyLock::new(|| {
  format!(
    ...
    腕に麻の欠片がついているわ。\\n\
    \\p[2]\\![bind,icon,没入度3,1]\\0\\![anim,offset,903002,0,-100]\
    夜を狙って、こっそりと忍び込んだのね。\\n\
    \\p[2]\\![bind,icon,没入度4,1]\\0\\![anim,offset,903002,0,-150]\
    そうして、私のもとに。\\n\
    \\p[2]\\![bind,icon,没入度5,1]\\0\\![anim,offset,903002,0,-250]\
    いつも疑問に思っているのよ。\\n\
    そうまでして得たいものって何かしら？\\n\
    \
    \\![bind,シルエット,黒塗り4,1]\
    ...
    \\x\
    \
    h1111206話し相手がいなくて倦んでいたところだったの。\\n\
    長い夜は、死よりもつらいもの。\\n\
    h1111211だからお話をしましょう、お互いのために。\\n\\n\
    h1111201私はハイネ。幽霊屋敷の主。\\n\
    h1111210訪問者\\f[bold,1]{{user_name}}\\f[bold,0]、\\n\
    この家の主として、あなたの訪問を歓迎します。\\n\
...
pub(crate) static FIRST_RANDOMTALKS: LazyLock<Vec<String>> = LazyLock::new(|| {
  vec![
    "\
      ...
      私があなたを救うこともない。\\n\
      無為な希望を持たないように、\\n\
      あえて言っておくけれどね。\\_w[1200]\\n\
      \\n\
      死者が生者にできることなどたかが知れているし、\\n\
      あなたの生き死には、h1111210あなたのものだから。\
      \\x\
      ...
      過去に犯した罪、\\n\
      好みの散歩ルート、なんでもいいの。\\n\
      h1111205この倦み腐った脳に刺激を与えてくれるなら、\\n\
      情報に貴賤はないわ。\
      \\x\
      ……h1111210なにせ、私はここをろくに動けない身だから。\\n\
      h1112205ずっと、ずっと、ずっと、独りだったの。\\n\
    ...
    "\
      ...
      ……h1141101ああ、h1111204あなたには見えないのかしら？\\n\
      低級霊だものね。\\n\
      \\n\
      ……h1111206そう、ならば伝えておく必要があるわね。\\n\
      この部屋には、常に数人の召使がついているの。\\n\
      h1111201……h1111204驚いた？\\n\
      まあ、普段は居ないのとそう変わらないわ。\\n\
      お茶のおかわりが欲しかったら、\\n\
      h1111306そうね……あのあたりに合図を送ればいいわ。\\n\
      \\x\
