  ...
  fn talks(&self) -> Vec<String> {
    match self {
      ...
      Self::Past => vec![
        ...
        h1112205だからといって、他人に責をなすりつけるほど無神経でもいられなかった。\\n\
      ...
      Self::Abstract => vec![
        ...
        どうしようもなく、愛しいの。\\n\\n\
        h1111206あなたの目には、贔屓目にも綺麗には写らないでしょう。\\n\
      ...
      Self::WithYou => vec![
        ...
        format!("\
        h1111202ある程度外見を変えることもできるの。h1111207……こんなふうに。\\n\\n\
        h1000000{}\\n\
        ...
        命を落とした際に衛生観念やその他の生存本能が失われるから……とかなんとか。\\n\
        ...
        どんなあなたでも私は否定しないと決めた。h1111209それが大事なことだから。\
        ".to_string(),
