...
pub static TALKS: Lazy<Vec<String>> = Lazy::new(|| {
  vec![
    ...
    h1111207羨ましいわ。\\n\
    h1111207私は\\_a[Fastened,どういうこと？]見ていることしかできない\\_aから、なおさら。\
    ".to_string(),
    ...
    "\
    h1111201あなたの趣味……ゴスファッション、だったかしら。\\n\
    h1111207素敵ね。私もそういうのは好きよ。\\n\
    ……h1111206現代ではなにかと色眼鏡で見られるそうだけど、\\n\
    気にする必要はないわ。\\n\
    h1111209自分の好みを追求するのが一番気持ちいいのは、いつの時代も一緒よ。\
    ".to_string(),
    ...
    "\
    h1111205みじめな人生の上に正気でいるには、一日は長すぎたの。\\n\
    ".to_string(),

    "\
    h1111209賢い人とかわいい人が好きなの。\\n\
    h1111201まあ、あなたがどちらでもなくても問題はないわ。\
    h1111204あなたへの興味は、そういうところにあるわけじゃないから。\
    ……h1111207あら、かわいい人だったのかしら。\
    ".to_string(),
    ...
    だから幽霊同士、h1111206ましてや人と幽霊の間に\\n\
    恋愛が生まれることは皆無といっていいでしょう。\\n\
    ...
    ……h1111209それだけ、人に期待するものが少なかったということ。\
    ".to_string(),
  ]
});
