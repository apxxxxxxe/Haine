...
pub fn random_talks(talk_type: TalkType) -> Vec<Talk> {
  let strings = match talk_type {
      TalkType::SelfIntroduce => vec![
        ...
        h1123310霊力の強い霊は、特定の場所に縛られる傾向にあるの。\\n\
        ...
        死の意識が集まりやすい土壌があるの。\\n\
        ……h1111210あなたがここに来たのも偶然ではないのかもしれないわね。\
        ".to_string()),
      ...
      TalkType::WithYou => vec![
        ...
        ("見ていることしかできない", "\
        h1111210あなたたちが歩いている姿を、いつも窓から見ているの。\\n\
        h1111204いつも何かをして、どこかへ向かっている。\\n\
        h1111211羨ましいわ。h1111211私は\\_a[Fastened,どういうこと？]見ていることしかできない\\_aから、なおさら。\
        ".to_string()),
      ...
      TalkType::Abstract => vec![
        ...
        どうしようもなく、愛しいの。\\n\\n\
        h1111210……幻滅するでしょう。あなたの目には、贔屓目にも綺麗には写らない。\\n\
        h1111310……でもね。倫理は私を救わない。\\n\
        あなたの心を私が握る必要も、ない。\\n\
...
pub static FIRST_RANDOMTALKS: Lazy<Vec<String>> = Lazy::new(|| {
  vec!["\
      ...
      h1111210あなたの食事の好み、やめられない癖、なんでもいいの。\\n\
      h1111205この腐った脳に刺激を与えてくれるなら、情報に貴賤はない。\
      \\x\
      ……h1111210なにせ、私はここを出られない身なの。\\n\
