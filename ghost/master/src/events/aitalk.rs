...
pub static TALKS: Lazy<Vec<String>> = Lazy::new(|| {
  vec![
    "\
    h1121205牙も鎧もなしに、どう戦えというの。\
    ".to_string(),

    "\
    h1111201怖いものだからこそ、見つめなければ戦えない。\\n\
    ……h1121205そんなもの、戦える人だけの論理だわ。\
    ".to_string(),

    "\
    h1111204……なにか不安なの？\\n\
    それとも、何が不安かもわからない？\\n\
    h1111209紙に書き出してみるといいわ。\\n\
    ...
    "\
    h1111209この前、スプレーで外壁に落書きしていった人がいたの。\\n\
    h1111206今ごろは、\"原因不明の熱病\"に苦しんでいるんじゃないかしら。\\n\\n\
    h1111209報いあれ。呪いあれ。h1111205私にはその力があるのだから。\
    ".to_string(),
    ...
    "\
    h1111209燃え殻がひとりでに崩れるように、心が転がり落ちて戻らなくなった。\\n\
    h1111205だから私は諦めたの。\
    ".to_string(),
    ...
    h1111209雄弁は銀、沈黙は金。h1111204必要なときに口を開けるかが大事よね。\
    ".to_string(),

    "\
    h1111209中途半端な助けは、何もしないより残酷だわ。\\n\
