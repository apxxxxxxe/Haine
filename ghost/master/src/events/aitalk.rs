...
pub fn on_ai_talk(_req: &Request, vars: &mut GlobalVariables) -> Response {
    let talks = vec![
            ...
            h1122305だって、せっかくこの世に生まれたのに。こんなにも自由なのに。……この手で、何をすることもできるはずなのに！\\_w[1200]\
            \\n\\n{}
            ……h1121209ごめんなさい。……h1111209忘れてちょうだい。\
            ",
            user_talk("ハイネ……。","思わず、声が漏れる。")),
            ...
            ",
            user_talk("……髪が伸びてる！","霧が彼女を包んだかと思うと、その姿は一瞬で変わった。")),
            ...
            ",
            user_talk("最初はただ高給に釣られただけだった","嘘をついても仕方がない。だが……"),
