  ...
  fn talks(&self) -> Vec<Talk> {
    let strings = match self {
      Self::SelfIntroduce => vec![
        ...
        "\
        h1111203カンテルベリオには霊……正確には、死の意識が集まりやすい土壌があるの。\\n\
        ...
        ……h1111209これから、彼らと話す機会もあるかもしれないわね。\
        ".to_string(),
      ],
      Self::Lore => vec![
        "\
      ...
      Self::Abstract => vec![
        ...
        ".to_string(),
        "\
        h1111209「なぜみんな私をわかってくれないの？」\\n\
        h1111205他人があなたではなく、あなたが他人でないからよ。\\n\
