...
pub fn random_talks(talk_type: TalkType) -> Vec<Talk> {
  let strings = match talk_type {
      TalkType::SelfIntroduce => vec![
        ...
        h11233010今読んでも、他人の伝記を読んでいるようだわ。\\n\
        ".to_string()),

        ("外出できない理由", talk_with_punchline("\
        h11233010霊力の強い霊は、特定の場所に縛られる傾向にあるの。\\n\
        h1113205私もそう。結び付きが強すぎて、この家から離れられないのよ。\\n\
        ".to_string(),
        "\
        h11232010……まあ、外に出たとしても問題は山積みでしょうけど。\\n\
        ...
        死の意識が集まりやすい土壌があるの。\\n\
        ……h11112010あなたがここに来たのも偶然ではないのかもしれないわね。\
        ".to_string()),

        ("生家の広さ", talk_with_punchline("\
        h11112010ここは私の生家なの。実際は別荘なのだけど。\\n\
      ...
      TalkType::WithYou => vec![
        ...
        ただの霧ではないの。乾いた霧よ。\\n\
        むしろ、性質としては私たちに近い。\\n\
        h11112010ただの霊である私がここまで力を持っているのも、\\n\
        この地に根付いているもののおかげ。\\n\\n\
        ...
        ("見ていることしかできない", "\
        h11112010あなたたちが歩いている姿を、いつも窓から見ているの。\\n\
        h1111204いつも何かをして、どこかへ向かっている。\\n\
        h11112011羨ましいわ。h11112011私は\\_a[Fastened,どういうこと？]見ていることしかできない\\_aから、なおさら。\
        ".to_string()),
        ...
        h11112010……というより、食そのものにあまり関心がなくてね。\\n\
        h1111205何かに没頭していると、食事をとる時間も惜しく思えてしまって。\\n\
        ……h11233010思えば、家政婦には随分と世話をかけたわね。\
        ".to_string()),
      ...
      TalkType::Past => vec![
        ...
        h11122010この気持ちには、どこにも行き場がなかったの。\
        ".to_string()),
        ...
        ……h11212010ただ、遺書くらいは書いたほうがよかったかしら。\
        ".to_string()),

        ("助けは遂げられず", "\
        h1111205助けようとしてくれた人は沢山いたけれど、\\n\
        h11212010それが遂げられることはついぞなかったわ。\
        ".to_string()),

        ("死なない理由", "\
        h11112010生きていて良かったと思えることは数えきれないほどあったわ。\\n\
        ...
        私は私の性質と不可分で、\\n\
        今ここにいる私は、私以外でいられない。\\n\
        h11222010だから、私として生きることができなかった私は、もうどこにもいられない。\
        ".to_string()),

        ("人と本", "\
        h1111205昔から、人と本の違いがわからなかったの。\\n\
        h1121204もちろん、区別がつかないという意味ではなくて。\\n\
        ……h11112010人に期待するものがそれだけしか無かったの。\
        ".to_string()),
      ...
      TalkType::Abstract => vec![
        ...
        どちらがその本の真の印象かしら。\\n\\n\
        h11112010私はどちらも正しいと思うの。\\n\
        ……h1111504卑怯だと思った？\\n\
        h11112010印象なんてその時々で変わるもので、h1111205一つに定まることなんて稀だもの。\\n\\n\
        ...
        どうしようもなく、愛しいの。\\n\\n\
        h11112010……幻滅するでしょう。あなたの目には、贔屓目にも綺麗には写らない。\\n\
        h11113010……でもね。倫理は私を救わない。\\n\
        あなたの心を私が握る必要も、ない。\\n\
        h1111304それを諦められるくらい、私は、これを諦められないのだから。\
        ".to_string()),

        ("死の向こう側", "\
        h11121010どうか、死の向こう側がありませんように。\
        ".to_string()),
        ...
        ("わがままな祈り", "\
        h11112010がんばっているってこと、\\n\
        理解できなくても見ていてほしかったの。\\n\
        ……h1121205わがままかしら。\
        ".to_string()),

        ("生者にとっての慰め", "\
        h11112010枯れ木に水をあげましょう。\\n\
        ...
        ("不可逆な崩壊", "\
        h11112010燃え殻がひとりでに崩れるように、心が静かに割れて戻らなくなった。\\n\
        h1111205だから、諦めたの。\
        ".to_string()),

        ("中途半端な助け", "\
        h11112010中途半端な助けは何もしないより残酷だわ。\\n\
        ...
        h11213010そうなればすべて台無し。h1121304諦めるしかなかったわ。\
        ".to_string()),
        ...
        h11122010それって、この上なく残酷なことだわ。\
        ".to_string()),

        ("一つの個としての限界", "\
        h1111203世界が複雑で曖昧すぎるから、\\n\
        私たちは認識したものを理解できる形に歪めてしまう。\\n\
        h11112010既存の分類に当て嵌めて、安心を優先するの。\\n\
        曇る視界と引き換えにね。\\n\
        ...
        ("自分の理解者は自分だけ", "\
        h11112010「なぜみんな私をわかってくれないの？」と誰もが思う。\\n\
...
static BOTSU: Lazy<Vec<(&str, String)>> = Lazy::new(|| {
  vec![
    ...
    h1111204……なにか不安なの？\\n\
    それとも、何が不安かもわからない？\\n\
    h11112010……紙に書き出してみるのはどうかしら。\\n\
    h1111205いくらか整理がつくかもしれない。\
    ".to_string()),

    ("", format!("\
    h1111201ある程度外見を変えることもできるの。h11112011……こんなふうに。\\n\\n\
    h1000000{}\\n\
    \\0髪も、身長も、年齢すら、私たちには関係ないの。\\n\
    h11112010\\1瞬きしたとき、彼女はまた元の姿に戻っていた。\
    h1111204あまり大きく変化すると自己認識が揺らいでしまうから、基本的には最も自分らしい姿をすることが多いわ。\\n\
    h11112011こういう戯れもたまにはいいでしょう？\
    ",
    ...
    ……h11112010何も、知ることができないの。老人の、幼子の、男の、女の、見る世界を、\\n\
    そのすべてを私がこの身で知ることはかなわない。h1111205決して、……h11112010決して。\\n\
...
pub static FIRST_RANDOMTALKS: Lazy<Vec<String>> = Lazy::new(|| {
  vec!["\
      ...
      \\n\
      h11132010……相当な覚悟がなければ決断できなかったでしょう。\\n\
      ...
      あなたの生死は、h11112010なんというか、あまり大きな関心事ではないから。\
      \\x\
      ……h1111201あなたに興味がないわけではないのよ。\\n\
      h11112010もしそうならば引き止めたりせずに追い出しているわ。\\n\
      h1111204ただ、あなたの宿痾に特別な興味があるわけではないということ。\\n\
      h11112010あなたの食事の好み、やめられない癖、なんでもいいの。\\n\
      h1111205この腐った脳に刺激を与えてくれるなら、情報に貴賤はない。\
      \\x\
      ……h11112010なにせ、私はここを出られない身なの。\\n\
      h1112205ずっと、ずっと、ずっと、退屈だったのよ。\\n\
      h1111204そんなところにあなたという玩具が\\n\
      転がりこんできたものだから、\\n\
      都合のいい遊び道具として使っているの。\\n\
      \\n\
      ……h11112010ふふ、ここまで言われても怒らないのね。\\n\
      とても、根深い。h11112011ますます気に入ったわ。\
      \\x\
      ...
      h11132010肉体は重くはあれど強固な鎧だったのだと、死んだ後からしみじみ思うわ。\
      \\x\
      h1111204……混乱しているかしら。\\n\
      今すぐにすべてを理解する必要はないわ。\\n\
      どうせ時間はたっぷりあるのだから。\\n\
      ...
      深く、コクのある味わい。……美味しい。\\n\
      h11112011悪くないでしょう？h1111204それが私のお気に入り。\
      ……h11112011これで、私の好物を1つ知れたわね。\\n\
      h1111204全て、このように。\\n\
      じっくり、互いを知っていけばいいのよ。\
      ".to_string()
  ]
