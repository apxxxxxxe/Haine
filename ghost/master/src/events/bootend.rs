...
pub(crate) fn halloween_boot(_req: &Request) -> Result<Response, ShioriError> {
    let v = "\
        ...
        \\n[half]\
        h1211204あら、そう？h1211206そんなことは無いのだけれど……。\\n\
        h1111210お祭りも悪戯も、楽しいものじゃない。\\n\
        \\n[half]\
        h1211204\\1ハイネは満足そうに微笑んでいる。\\n\
        よく見ると、いつもより華やかな装いをしているようだった。\\n\
        いつも重たい印象のカーテンには、橙色の飾りが軽やかに下がっている。\\n\
        \\n[half]\
        h1211204今夜は特別なのよ。年に一度、死者と生者の境界が曖昧になる夜。\\n\
        h1211206私たちにとっても無縁ではない、唯一の宴。\\n\
        h1211210……あなたも、一緒に楽しんでくれるかしら？h1211204\\n\
        \\n[half]\
        \\1ハイネは優雅に手を差し出した。\\n\
        客間には、嗅ぎ慣れない甘い香りが漂っている。\\n\
        \\n[half]\
        h1211206お菓子を用意したの。\\n\
        生者の世界の伝統に倣ってね。\\n\
        私に用意できるものは限られているけれど……\\n\
