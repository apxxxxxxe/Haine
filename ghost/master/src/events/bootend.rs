...
pub fn on_first_boot(_req: &Request) -> Response {
  let m = "".to_string() + "\
        ...
        h1111204あなたは、じつに無防備だわ。h1111209きっと、ただの物見遊山のオカルト好きなのね。\\n\\n\
        \
        \\1……彼女の推察は完璧に当たっている……。\\n\\n\
        \
        ...
        \
        h1111102…………h1111302ねえ、\\n\
        自分のテリトリーを土足で踏み荒らされるのがどれだけ嫌か。\\n\
        あなた、\\![bind,シルエット,黒塗り3,1]\\![bind,ex,こわいかお,1]h1111101\
        " + &shake("考えたことはある？") + "\\n\\n\
        \
        \\1ぞくり、と背筋に冷たいものが走る。\\n\
        ...
        h1123209ねえ、あなた。\\n\
        あなたのその狭い視野、臆病なくせに愚鈍な態度、h1123305まるで親に置いていかれた子犬みたいだわ。\\n\\n\
        \
        \\1……空気が、緩んだ……？\\n\\n\
        \\x\
        h1111201いいわ、気に入った。許してあげる。\\n\\n\
        h1111209……私はここでずっと、終わりを待っているのよ。\\n\
