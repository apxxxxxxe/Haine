...
pub fn on_first_boot(_req: &Request) -> Response {
  let m = "".to_string() + "\
        ...
        「カンテルベリオの幽霊屋敷」その手のマニアの間では有名な廃墟だ。\\n\
        古い洋館のような建物で、周囲は小さな庭園に囲まれている。\\n\
        何度か取り壊しの話が出たが、原因不明の事故が続いたため、現在も残っているいわくつきの場所。\\n\
        \\n\
        ここには幽霊が出るという。\\n\
        目撃情報は多々あり、そして、見た者の多くが病気や事故に遭っている。\\n\
        それは呪いによるものなのか、それともただの偶然か。\\n\
        何にせよ、じつに興味を惹かれた。だから今日、私はここを訪れたのだ。\\x\
        \
        \\1玄関から入って、廊下を進む。\\n\
        埃っぽさは無いが、しかし生活感もない。\\n\
        窓をきっちりと覆っている重たげなカーテンは、長いこと開いていないようだった。\\n\
        \\n\
        しばらく歩き、客間へと入ったときだった。\\n\
        人の気配。\\_w[1000]\\n\
