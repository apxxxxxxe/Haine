...
pub fn on_first_boot(_req: &Request) -> Response {
  let m = "".to_string() + "\
        ...
        汝、己を客なりと信じるならば進み給え。賊なりと念じるならば退き給え。\\f[default]\\n\
        ...
        わが主よ、是を恩と為すか、仇と為すか、その賢明なる眼差しにて、定め給え！\\f[default]\\n\
		...
		いつも自分の行動はなにかに邪魔される。じゃあ、私はどうすればいいのだ。\\n\
        どうすれば、よかったのだ。\\n\
		『…………死にたい。』\\_w[1000]\\n\
        ...
        \\x
        \
        h1111109\\![bind,ex,こわいかお,0]\\c…………。h1123207\\![bind,シルエット,,0]くく、ふふふ。\\n\
        h1123201ああ、おかしい。h1123204あなた、ここに死にに来たの？\\n\
        \
        \\1……空気が、緩んだ……？\
        \\x\
		h1131305ああ、こういう方向から来るのは初めてね。\\n\
        h1111201いいわ、気に入った。h1111204許してあげる。\\n\\n\
        \
        \\1……助かった、のだろうか。\\n\\n\
        \
        h1111204命は取らないでおいてあげるわ。\\n\
        h1111206なんて、元からそんなつもりもないけれど。\\n\
        h1111209ただし。h1111201その代わりにあなた、しばらくここに居なさい。\\n\\n\
        \
        \\1φ……？\\n\\n\
        \
        h1111201土足で踏み込んだ報いを与えるのよ。お咎めなしでは禍根が残るでしょう。\\n\
        h1111209……まあ、払えないものを要求するつもりはないわ。\\n\
		h1113206そういうシナリオは大概つまらないというのもあるけれど。\\n\\n\
        \
